...
class SelectVolumesStep(TMRIChangeDetectorStep):
  ...
  def loadTestData(self):
    ...
    if sys.platform == 'linux2':
      ...
      vol1 = vl.AddArchetypeVolume('/Users/mariana/Documents/Uppsala/thesis/volumes/first_batch/mod_patient1-us1/test.dcm', 'volume1', 0)
      vol2 = vl.AddArchetypeVolume('/Users/mariana/Documents/Uppsala/thesis/volumes/first_batch/mod_patient1-us2/test.dcm', 'volume2', 0)
    else:
